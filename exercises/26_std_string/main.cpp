...
int main(int argc, char **argv) {
    ...
    auto hello = "Hello"s;
    auto world = "world";
    //std::cout<< "decltype(hello)="<< decltype(hello) <<std::endl;
    ...
    ASSERT((std::is_same_v<decltype(hello), std::string> == true), "Fill in the missing type.");
    ASSERT((std::is_same_v<decltype(world), const char *> == true), "Fill in the missing type.");
    // TODO: 将 `?` 替换为正确的字符串
